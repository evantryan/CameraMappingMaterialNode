...
node_categories = [
    ShaderNodeCategory("CUSTOM_SHADER_NODES", "Mapping Nodes", items=[
...
def register():
    ...
    register_node_categories("CUSTOM_SHADER_NODES", node_categories)
    #node_menu_include('PIPELINE_NODES', "Pipeline Nodes", CameraMappingShaderNode)

def unregister():
    unregister_node_categories("CUSTOM_SHADER_NODES")
